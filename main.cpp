...
// Pinconfiguratie voor het 3.5 inch display voor de UNO
#define TFT_CS     10
#define TFT_RST    -1 // Je kunt deze pin ongebruikt laten als je geen reset-pin gebruikt
#define TFT_DC     9

// Maak een object van de Adafruit_ILI9341 klasse
...
int main(void) {
  ...
  // Zet de achtergrondkleur van het scherm
